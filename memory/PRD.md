...
- Mid-match formation change with smart auto-fill (last position > preferred position)
- In-match event logging: Tap player → Goal / Assist / Yellow / Red / Sub

### Match History & Amendments
- Match list with opponent, score, date
- **Editable match detail page**:
  - Edit score (home/away)
  - View/add/delete match events (goals, assists, cards, subs)
  - Add/edit/delete player ratings (1-10 scale with notes)
  - Add match notes
- All amendments saved to backend and reflected in player statistics
...
## Changelog
- 2026-02-22 (Session 3): Fixed stats counting bug (doEndMatch no longer overwrites structured events). Rebuilt match-detail.tsx with editable score, events, player ratings, and match notes.
...
- Backend tests: `/app/backend/tests/test_stats_and_events.py`
