...
import { COACHING_CATEGORIES, CoachingCategory, CoachingSuggestion, TacticalArrow } from '../src/lib/coaching-data';
...
const styles = StyleSheet.create({
  ...
  coachQuote: { fontSize: 13, fontWeight: '700', color: Colors.white, fontStyle: 'italic', lineHeight: 18 },
  coachQuotedBy: { fontSize: 11, fontWeight: '600', color: Colors.textMuted, marginBottom: 8 },
