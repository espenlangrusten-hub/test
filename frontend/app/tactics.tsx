...
const styles = StyleSheet.create({
  ...
  saveOnlyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 52, borderRadius: 12, gap: 6, paddingHorizontal: 20, borderWidth: 1.5, borderColor: Colors.primary, width: '22%' },
